                    ...
                    <div className='grid grid-cols-2 w-full gap-4 p-2'>
                        ...
                        <div className='flex justify-between items-center'>
                            <div className='flex flex-col gap-2'>
                                ...
                                <p className='text-[#6D6C6C] font-sans text-xs'>{allpropertyDetails?.builtup_area} sq.ft. | {allpropertyDetails?.furnished_status} | {allpropertyDetails?.property_name}</p>
