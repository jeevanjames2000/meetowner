...
function Addpropertydetails({
  ...
  const propertySubTypeIcon = {
    ...
    'Flat': (
      <svg width="28" height="28" viewBox="0 0 36 45" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    'Independent House': (
      <svg width="28" height="28" viewBox="0 0 54 45" fill="none" xmlns="http://www.w3.org/2000/svg">
