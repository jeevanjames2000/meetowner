    ...
    <div className='relative'>
      ...
      <div className='w-full overflow-y-auto px-5 py-3 h-[calc(100vh-220px)]'>
        ...
        <div className='mb-5'>
          ...
          {carParkingError && <p className='text-[#FF0000] text-xs font-sans'>Please select covered parking</p>}
        </div>
        <div className='mb-5'>
          <div className='flex gap-1 mb-4'>
          ...
          {carParkingError && <p className='text-[#FF0000] text-xs font-sans'>Please select bike parking</p>}
        </div>
        <div className='mb-5'>
          <div className='flex gap-1 mb-4'>
