...
function Enquirycard({ image, property_name, unique_property_id, sub_type, property_for, google_address, builtup_area, property_cost, area_units, monthly_rent, user_name, user_email, user_mobile }) {
    ...
    return (
        <div className="grid grid-cols-12 items-start w-full rounded-[10px] border-[1px] border-[#1d3a7652] bg-[#E2EAED] px-2 py-[10px]">
            <div className='col-span-12 sm:col-span-5 flex w-full space-x-2 pt-4'>
                <Image
                    src={image}
                    alt={"enquiry_1"}
            ...
            <div className='flex flex-col col-span-12 xxm:col-span-8 sm:col-span-5 space-y-1 xxm:pl-6'>
                <p className='text-[10px] xs:text-[11px] 2xl:text-[16px] 3xl:text-[18px] 4xl:text[20px] text-[#252525] font-[700]'>
                    August-12-2024
                </p>
