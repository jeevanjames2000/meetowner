            ...
            <div className='grid grid-cols-6 lg:grid-cols-12 w-full'>
                <div className=' flex flex-col xxm:flex-row col-span-6 h-full gap-3'>
                    ...
                    <div className="px-2 xxm:px-0 space-y-2 py-2">
                        <p className="text-[9px] xs:text-[11px] 2xl:text-[15px] 3xl:text-[17px] 4xl:text-[19px] font-[700] text-[#6d6c6c]">{property_name || ''}</p>
                        ...
                        <div className='flex flex-row items-center gap-2'>
                            {
                                ...
                                <p className="text-[9px] xs:text-[11px] 2xl:text-[15px] 3xl:text-[17px] 4xl:text-[19px] font-[700] text-[#6d6c6c]">{`${bedrooms} BHK`} </p>
                        ...
                        <div className='flex flex-row items-center gap-2'>
                            ...
                            <p className="text-[9px] xs:text-[11px] 2xl:text-[15px] 3xl:text-[17px] 4xl:text-[19px] font-[600] text-[#757575]"><span className=''>{facing ? `${facing} facing` : '-----'}</span></p>
                        </div>
                ...
                <div className=' flex flex-col col-span-6 py-3 justify-between'>
                    <div className='flex px-2 lg:px-0 gap-2 pr-4'>
                        <p className=" flex flex-col text-[9px] xs:text-[11px] 2xl:text-[15px] 3xl:text-[17px] 4xl:text-[19px] font-[400] text-[#6d6c6c] ">Last Updated<span className='font-[600] block pt-2'> {updated_date}</span></p>
                        <p className=" flex flex-col text-[9px] xs:text-[11px] 2xl:text-[15px] 3xl:text-[17px] 4xl:text-[19px] font-[400] text-[#6d6c6c] border-l-[0.09rem] border-r-[0.09rem] border-[#909090] px-3 mx-4 ">Expiry on<span className='font-[600] block pt-2'> {expiry_date}</span></p>
                    ...
                    <div className='flex px-2 lg:px-0 flex-wrap items-center justify-center pt-1 lg:pt-0 xxm:justify-start gap-4 '>
                        ...
                        <button onClick={() => openDeleteModal(unique_property_id)} className='flex items-center justify-center  text-[8px] xs:text-[10px] 2xl:text-[14px] 3xl:text-[16px] 4xl:text-[18px] font-[700] text-[#ffffff]  bg-[#A5413F] h-5 2xl:h-6 3xl:h-7 4xl:h-8 px-3 2xl:px-4 3xl:px-5 4xl:px-6 rounded-l-full rounded-r-full gap-2'>
