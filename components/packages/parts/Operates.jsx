...
function Operates() {
    return (
        <div className='flex flex-row  items-center   bg-[#FCFCF3] py-7 px-20 w-full gap-28 rounded-[10px]'>
            <p className='text-[26px] text-[#116D85] text-start font-bold  w-[30%]'>
                How It Operates ?
            </p>
            <div className=' grid grid-cols-1 md:grid-cols-2 grid-rows-2 w-[70%] gap-12'>
                <div className='col-span-1 row-span-1 flex flex-row items-center gap-12'>
                    ...
                    <div className=' flex flex-col mx-auto'>
                        ...
                        <p className="text-center text-[12px] font-[600] text-[#116D85] space-y-2 pt-4">
