...
function Propertyoverview() {
    ...
    return (
        <div className="propertyprice space-y-6">
            <p className="text-[#1D37A6] text-[30px] font-[600]">LAKESCAPE Overview</p>
            <div className="custom-shadow p-6 space-y-8 bg-[#F3F3F3] rounded-md">
                ...
                <div className="grid grid-cols-3 gap-4">
                    {projectDetails.map((project, index) => (
                        <div
                            key={index}
                            className=" flex items-center justify-start  p-[10px] gap-4"
                        >
                            <Image
                                src={project.image}
                                alt={project.name}
                            ...
                            />
                            <div>
                                <p className="text-[18px] text-[#212529] font-[600]">{project.name}</p>
                                <p className="text-[16px] text-[#434343] font-[600]">{project.project_details}</p>
                            </div>
                        </div>
                    ))}
                </div>
