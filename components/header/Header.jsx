            ...
            </Link>
            {
                isLogged ?
                    <>
                        ...
                        <div id='sidebar' className={`fixed top-0 right-0 h-full w-[70%] z-50 bg-[#F2F2F2] md:hidden flex-col gap-4 transition-transform duration-20 ease-linear ${
                    ...
                    <div className="flex flex-row justify-start items-center gap-4">
                        <Link href="/downloadapp" className="flex flex-row items-center justify-start gap-2 3xl:gap-4">
                            ...
                            <button className="text-[#1D3A76] hidden sm:flex text-[12px] md:text-[12px] lg:text-sm 2xl:text-[16px] 3xl:text-[32px] font-medium font-sans">Download App</button>
                        </Link>
                        <Link href="/addproperty" className="flex flex-row items-center justify-center gap-2 3xl:gap-4 p-2 rounded-md">
                            ...
                            <button className="text-[#1D3A76] hidden sm:flex text-[12px] md:text-[12px] lg:text-sm 2xl:text-[16px] 3xl:text-[32px] font-medium font-sans">Add Property</button>
                        </Link>
