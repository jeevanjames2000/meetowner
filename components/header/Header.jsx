...
<div
            ...
            className={`h-[65px] 3xl:h-[120px] bg-[#F2F2F2] overflow-visible w-full py-2 transition-all duration-1000 shadow-xl flex flex-row justify-between items-center px-4 md:px-[4vw] lg:px-[6vw] ${scrollY > 120 ? 'sticky top-0 z-50' : ''}`}
>
<Link href="/dashboard">
...
<div id='sidebar' className={`${isSidebarOpen ? 'flex' : "hidden"} md:hidden flex-col gap-4 bg-[#F2F2F2] fixed top-0 right-0 h-full w-[70%] z-50`}>
...
<Link href="/downloadapp" className="flex flex-row items-center justify-start gap-2 3xl:gap-4">
<Image src={downloadapp_svg} alt='downloadapp_svg' className='h-[16px] w-fit 3xl:h-9 3xl:w-fit object-cover' />
<button className="text-[#1D3A76] hidden sm:flex text-[12px] md:text-[12px] lg:text-sm 2xl:text-[16px] 3xl:text-[26px] font-medium font-sans">Download App</button>
</Link>
...
<button className="text-[#1D3A76] hidden sm:flex text-[12px] md:text-[12px] lg:text-sm 2xl:text-[16px] 3xl:text-[26px] font-medium font-sans">Add Property</button>
</Link>
...
<button className="text-white text-[12px] md:text-[12px] lg:text-sm 2xl:text-[16px]  3xl:text-[26px] font-medium font-sans">Login</button>
</Link>
</div>
