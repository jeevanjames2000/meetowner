    ...
    return (
        <>
            <div className="flex flex-row items-center justify-between  gap-10">
                <Link href="/enquiry" className="font-semibold text-sm text-[#1D3A76] border-b-2 border-[#1D3A76]"> Dashboard</Link>
                <Link href="#" className="font-semibold text-sm text-[#1D3A76]"> Enquires</Link>
                <Link href="#" className="font-semibold text-sm text-[#1D3A76]">Listings</Link>
                <Link href="#" className="font-semibold text-sm text-[#1D3A76]">Packages</Link>
