...
function Checkoutpropertywrappercard(item) {
    return (
        ...
        <div className="w-[70%] space-y-1">
            <p className="text-[16px] font-[700] text-[#6d6c6c] w-[80%]">{item.land}</p>
            <p className="text-[14px] font-[400] text-[#6d6c6c]">{item.area}</p>
            <p className="text-[14px] font-[400] text-[#6d6c6c] pb-3">{item.cost}</p>
    
            {/* Action Section */}
            <div className="flex flex-row items-center justify-between border-t-[1.5px] border-t-[#E2EAED] pt-3">
                <p className="text-[14px] font-[400] text-[#6d6c6c]">Plan upgrade required</p>
                <button
